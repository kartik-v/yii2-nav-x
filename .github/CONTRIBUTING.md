Contributing to yii2-nav-x
==========================
Looking to contribute something to yii2-nav-x? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/nav-x) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-nav-x
-----------------------------
...
- What version of jQuery are you using? And what version of yii2-nav-x?
- Are you using yii2-nav-x with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-nav-x
------------------------------------------
Before starting work on a major feature for yii2-nav-x, **read the
[documentation](http://demos.krajee.com/nav-x)  first** or you may risk spending a considerable amount of
...
yii2-nav-x regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-nav-x that contain test cases and
...
It should also be made clear that **all code contributed to yii2-nav-x** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[issue-search]: https://github.com/kartik-v/yii2-nav-x/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/yii2-nav-x/issues
[licensing]: https://github.com/kartik-v/yii2-nav-x/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-nav-x
[requesting-features]: #requesting-features-in-yii2-nav-x